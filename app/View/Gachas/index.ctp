...
if (!$this->Time->isPast($gacha['Gacha']['dateFinish']) && $gacha['Gacha']['type'] == 'Box') {
?>
...
<div class="row text-center center-block">
    <div class="col-sm-12 col-lg-12">
        <?php } else if (!$this->Time->isPast($gacha['Gacha']['dateFinish']) && $gacha['Gacha']['type'] == 'Regular') { ?>
            <div class="row text-center">
                        ...
                        <div class="row">
                            <div class="table-responsive">
                                <table class="table text-left">
                                    <?php
                                    $alldays = explode('|', $gacha['Gacha']['boxGachaDays']);
                                    echo '<tr>';
